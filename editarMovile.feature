Feature: Editar Canal de SMS da Movile
    Permitir alterar um canal de SMS da integradora Movile
...
Scenario: Sucesso ao Editar Login
    And clicar no botão "Editar"
    Then será aberto uma modal 
    And deverá inserir o novo valor no campo "Login"
    And clicar no botão "Salvar"
    Then a modal deve ser fechada
    And será exibida a mensagem "Os dados foram atualizados com sucesso!"
    And o canal será alterado

Scenario: Sucesso ao Editar Token de Autenticação
    And clicar no botão "Editar"
    Then será aberto uma modal 
    And deverá inserir o novo valor no campo "Token de Autenticação"
    And clicar no botão "Salvar"
    Then a modal deve ser fechada
    And será exibida a mensagem "Os dados foram atualizados com sucesso!"
    And o canal será alterado
...
Scenario: Falha ao Editar o Login
    And clicar no botão "Editar"
    Then será aberto uma modal 
    And apague o conteúdo do campo "Login"
    And clicar no botão "Salvar"
    Then será exibida a mensagem "Preencha os campos obrigatórios."
    And o canal não será alterado

Scenario: Falha ao Editar o Token de Autenticação
    And clicar no botão "Editar"
    Then será aberto uma modal 
    And apague o conteúdo do campo "Token de Autenticação"
    And clicar no botão "Salvar"
    Then será exibida a mensagem "Preencha os campos obrigatórios."
    And o canal não será alterado